...
public class BaseRecyclerViewHolder extends RecyclerView.ViewHolder{
    ...
    protected BaseRecyclerViewHolder(Context context, View view) {
        super(view);
     ...
     * If you need more control over the Picasso settings, use {BaseRecyclerViewHolder#setImageBuilder}.
     *
     * @param viewId   The view id.
