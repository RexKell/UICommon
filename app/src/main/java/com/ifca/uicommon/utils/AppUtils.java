...
public class AppUtils {
    ...
    public static boolean isInstallApp(Context context, String packageName) {
        return !isSpace(packageName) && IntentUtils.getLaunchAppIntent(packageName, context) != null;
    }
    ...
    public static void installApp(Context context, File file) {
        ...
        context.startActivity(IntentUtils.getInstallAppIntent(file, context));
    }
    ...
    public static void installApp(Activity activity, File file, int requestCode) {
        if (!FileUtils.isFileExists(file)) return;
        activity.startActivityForResult(IntentUtils.getInstallAppIntent(file, activity), requestCode);
    }
     ...
     *
     * @param filePath 文件路径
     * @return {@code true}:安装成功 {@code false}:安装失败
     */
    ...
    public static boolean isAppRoot() {
        ...
        if (result.errorMsg != null) {
            LogUtil.d("isAppRoot", result.errorMsg);
        }
        return false;
    }
    ...
    public static void launchApp(String packageName, Context context) {
        ...
        context.startActivity(IntentUtils.getLaunchAppIntent(packageName, context));
    }
    ...
    public static void launchApp(Activity activity, String packageName, int requestCode) {
        if (isSpace(packageName)) return;
        activity.startActivityForResult(IntentUtils.getLaunchAppIntent(packageName, activity), requestCode);
    }
     ...
     *
     * @param context 上下文
     * @return {@codex true} :是 {@code false} :否
     */
