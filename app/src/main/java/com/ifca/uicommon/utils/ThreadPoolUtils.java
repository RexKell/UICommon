...
import com.ifca.uicommon.xrecycler.LoadingIndicatorView;
...
public class ThreadPoolUtils {
    ...
    public static final int CashedThread = 1;
    public static final int SingleThread = 2;

    private ExecutorService executorService;
    private ScheduledExecutorService scheduledExecutorService;

    @IntDef({FixedThread, CashedThread, SingleThread})
     ...
     *
     * @param type         线程池类型
     * @param corePoolSize 只对Fixed和Schedule线程池起效
     */
    public ThreadPoolUtils(@Type int type, int corePoolSize) {
        ...
        switch (type) {
            case FixedThread:
                ...
                break;
            case SingleThread:
//                构造一个只支持一个线程的线程池，相当于newFixedThreadPoll(1);
     ...
     * @throws java.util.concurrent.ExecutionException 如果没有任务成功完成
     */
     ...
     * @throws java.util.concurrent.TimeoutException 如果在所有任务成功完成之前给定的超时期满
     */
